      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="bg-white rounded-lg border p-6">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-bold text-gray-900">Project Saksham</h1>
              <p className="text-gray-600 mt-2">Strategic Engines - Live Demo & Testing</p>
            </div>
                        ...
                        {phase.engines.map((engine, index) => (
                          <div
                            ...
                            className={`text-xs px-2 py-1 rounded ${
                              PHASE_1_ENGINES.some(e => engine.toLowerCase().includes(e.split('_')[0]))
