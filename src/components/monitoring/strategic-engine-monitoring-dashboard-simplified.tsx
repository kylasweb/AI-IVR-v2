// Real-time Monitoring Dashboard for Strategic Engine Performance (Simplified Version)
                        ...
                        {culturalMetrics && (
                            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                                ...
                                <Card>
                                    ...
                                    <CardContent>
                                        <div className="space-y-3">
                                            {Object.entries(culturalMetrics.regionalVariantUsage).map(([region, percentage]) => (
                                                <div key={region}>
                                                    <div className="flex justify-between text-sm mb-1">
                                                        <span>{region}</span>
                                ...
                                {/* Malayalam Usage Summary */}
                                <Card className="lg:col-span-2">
                                    <CardHeader>
                                        <CardTitle>Malayalam Usage & Cultural Adaptation Summary</CardTitle>
                                        <CardDescription>മലയാളം ഉപയോഗവും സാംസ്കാരിക പൊരുത്തപ്പെടുത്തൽ സംഗ്രഹവും</CardDescription>
                                    </CardHeader>
                                    <CardContent>
                                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                                            <div className="text-center p-4 bg-blue-50 rounded-lg">
                                                <div className="text-2xl font-bold text-blue-600">{culturalMetrics.malayalamRequestPercentage}%</div>
                                                <div className="text-sm text-gray-600">Malayalam Requests</div>
                                                <div className="text-xs text-gray-500">മലയാളം അഭ്യർത്ഥനകൾ</div>
                                            </div>
                                            
                                            <div className="text-center p-4 bg-green-50 rounded-lg">
                                                <div className="text-2xl font-bold text-green-600">{culturalMetrics.culturalAdaptationSuccess}%</div>
                                                <div className="text-sm text-gray-600">Cultural Success</div>
                                                <div className="text-xs text-gray-500">സാംസ്കാരിക വിജയം</div>
                                            </div>
                                            
                                            <div className="text-center p-4 bg-purple-50 rounded-lg">
                                                <div className="text-2xl font-bold text-purple-600">{culturalMetrics.familyIntegrationScore}%</div>
                                                <div className="text-sm text-gray-600">Family Integration</div>
                                                <div className="text-xs text-gray-500">കുടുംബ സംയോജനം</div>
                                            </div>
                                            
                                            <div className="text-center p-4 bg-orange-50 rounded-lg">
                                                <div className="text-2xl font-bold text-orange-600">{culturalMetrics.festivalAwarenessScore}%</div>
                                                <div className="text-sm text-gray-600">Festival Awareness</div>
                                                <div className="text-xs text-gray-500">ഉത്സവ അവബോധം</div>
                                            </div>
                                        </div>
                                    </CardContent>
                                </Card>
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                            ...
                            <Card>
                                <CardHeader>
                                    ...
                                    <CardDescription>പ്രകടന സംഗ്രഹം</CardDescription>
                                </CardHeader>
                                <CardContent>
                                    <div className="space-y-4">
                                        <div className="grid grid-cols-2 gap-4">
                                            <div className="text-center p-3 bg-blue-50 rounded">
                                                <div className="text-xl font-bold text-blue-600">287ms</div>
                                        ...
                                        <div className="grid grid-cols-2 gap-4">
                                            <div className="text-center p-3 bg-purple-50 rounded">
                                                <div className="text-xl font-bold text-purple-600">157</div>
                                                <div className="text-sm text-gray-600">Avg Throughput</div>
                                            </div>
                                            <div className="text-center p-3 bg-orange-50 rounded">
                                                <div className="text-xl font-bold text-orange-600">92.4%</div>
                            ...
                            <Card>
                                <CardHeader>
                                    ...
                                    <CardDescription>എൻജിൻ സ്ഥിതി അവലോകനം</CardDescription>
                                </CardHeader>
                                <CardContent>
                                    <div className="space-y-3">
                                        <div className="flex items-center justify-between">
                                            <div className="flex items-center gap-2">
                                                ...
                                                <span className="text-sm">Healthy Engines</span>
                                            </div>
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                            ...
                            <Card className="lg:col-span-2">
                                ...
                                <CardContent>
                                    <div className="space-y-4">
                                        {engineData.map((engine) => (
                                            <div key={engine.engineId} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                                                <div className="flex-1">
                                                    <div className="text-sm font-medium">{engine.name}</div>
                                                    <div className="text-xs text-gray-500">Malayalam Usage: {engine.malayalamUsage}%</div>
                                                    <Progress value={engine.malayalamUsage} className="h-1 mt-1" />
                                                </div>
                                                <div className="ml-4 text-right">
                                                    <div className="text-sm font-bold text-green-600">{engine.culturalAdaptationScore}%</div>
                                                    <div className="text-xs text-gray-500">Cultural Score</div>
                                                </div>
                                            </div>
                                        ))}
                                    </div>
